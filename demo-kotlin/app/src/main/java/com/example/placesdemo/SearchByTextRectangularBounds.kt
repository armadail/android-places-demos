 ...
 */
class SearchByTextRectangularBounds : AppCompatActivity() {
    ...
    private fun findrestaurant() {
        ...
        val delta = 0.1
        val southWest = LatLng(49.2820 - delta, -123.1171 - delta)
        val northEast = LatLng(49.2820 + delta, -123.1171 + delta)
